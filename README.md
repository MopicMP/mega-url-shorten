...
> Mega shorten urls using free apis

[![PyPI version](https://badge.fury.io/py/mega-url-shorten.svg)](https://pypi.org/project/mega-url-shorten/)
...
# Basic usage
result = shorten("your input here")
print(result)
```
...
from mega_url_shorten import batch
